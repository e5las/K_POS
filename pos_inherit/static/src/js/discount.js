odoo.define('pos_inherit.pos_inherit', function (require) {
"use strict";
...
var DiscountButton2 = screens.ActionButtonWidget.extend({
    ...
    apply_discount: function(pc) {
        ...
        if (base_to_discount>2000){
            var discount = - pc / 100.0 * 2000;
...
return {
    DiscountButton2: DiscountButton2,
}
